...
void FrameManager::identify_markers(const rs2::video_frame& color_frame, const rs2::depth_frame& depth_frame, DeepBreathFrameData* breathing_data)
{
...
void FrameManager::update_timestamps(const rs2::video_frame& color_frame, const rs2::depth_frame& depth_frame, DeepBreathFrameData* breathing_data)
{
	//add color timestamp:
...
void FrameManager::add_frame_data(DeepBreathFrameData * frame_data)
{
	// delete last frame
